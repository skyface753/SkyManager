...
const createFirstEintraege = "INSERT INTO `ticket_eintraege` (`ID`, `Ticket_FK`, `User_FK`, `Beschreibung`, `Arbeitszeit`, `Datum`, `Zeit`) VALUES (1, 10000, 'admin', 'Hallo, ich habe gearbeitet :D', 0, '2021-07-02', '10:53:26');"
...
const createFirstTicket = "INSERT INTO `ticket_tickets` (`ID`, `Kunden_FK`, `Titel`, `Beschreibung`, `Zustand_FK`, `User_FK`) VALUES (10000, 1, 'Willkommen', 'Hallo, dies ist das erste Ticket. Es hilft die Datenbank zum ersten Start vorzubereiten.Viel Spaß mit Ihrem neuen OpenSource Ticket-System und Doku-Manager', 1, 'admin');"
...
const createFirstWiki = "INSERT INTO `wiki` (`ID`, `Titel`, `Text`) VALUES (1, 'Willkommen', 'Hallo, dies ist das erste Wiki. Es hilft die Datenbank zum ersten Start vorzubereiten.Viel Spaß mit Ihrem neuen OpenSource Wiki-System und Doku-Manager');"
...
const createFirstNotifications = "INSERT INTO `notifications` (`ID`, `User_FK`, `Ticket_FK`, `Text`, `DateTime`, `isRead`) VALUES (1, 'admin', 10000, 'Hallo, ich habe gearbeitet :D', CURRENT_TIMESTAMP(), 0);"
